define(['exports', 'jquery', '../classes/Utils.min.js', './PanelController.min.js', 'Flagbit_EnhancedCMS/js/jsonform/config'], function (exports, _jquery, _UtilsMin, _PanelControllerMin) {
    'use strict';
