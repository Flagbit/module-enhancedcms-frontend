            ...
            init: function init() {
                ...
                _jquery2.default.each(widgets, function (i, widget) {
                    if (widget.type == 'container') {
                        _this.widgets.push(new _ContainerMin2.default(_this, $templateCache, $q, $interpolate, $compile, $mdDialog, widget, builderData.widgetUrl, _this.globalData));
                    } else if (widget.type == 'carousel') {
                        _this.widgets.push(new _CarouselMin2.default(_this, $templateCache, $q, $interpolate, $compile, $mdDialog, widget, builderData.widgetUrl, _this.globalData));
                    } else {
                        _this.widgets.push(new _WidgetMin2.default(_this, $templateCache, $q, $interpolate, $compile, $mdDialog, widget, builderData.widgetUrl, _this.globalData));
                    }
                });
