define(['exports', 'jquery', 'Flagbit_EnhancedCMS/js/ckeditor/ckeditor', './controllers/ContentController', './controllers/DialogController', './controllers/ConfigController', './controllers/ContainerController', './controllers/WidgetController', './controllers/ContainerWidgetController', './controllers/ContainerItemWidgetController', './controllers/CarouselWidgetController', './controllers/EditorController', './controllers/EditorToolbarController', './controllers/WidgetListController', './controllers/config/ProductSelectController', './controllers/config/ImageSelectController', './controllers/config/SizeUnitController', './controllers/config/OpacityController', './controllers/PanelController', './services/PanelService', './services/PanelBarService', './directives/DragDirective', './directives/WidgetDirective', './directives/ContainerWidgetDirective', './directives/ContainerItemWidgetDirective', './directives/CarouselWidgetDirective', './directives/StrictClassDirective', './directives/StrictSrcDirective', './directives/EditorDirective', './directives/WidgetListDirective', './directives/config/ProductSelectDirective', './directives/config/ImageSelectDirective', './directives/config/SizeUnitDirective', './directives/config/OpacityDirective', 'angular/angular.min', 'angular-animate/angular-animate', 'angular-aria/angular-aria', 'angular-material/angular-material', 'angular-messages/angular-messages', 'angular-redactor/angular-redactor', 'angular-sanitize/angular-sanitize', 'angular-dragdrop/src/angular-dragdrop', 'angular-resizable/src/angular-resizable', 'angular-translate/angular-translate', 'angular-ui-mask/dist/mask', 'ng-file-upload/ng-file-upload', 'spectrum/spectrum', 'jqueryui-touch-punch/jquery.ui.touch-punch', 'ckeditor/adapters/jquery'], function (exports, _jquery, _ckeditor, _ContentController, _DialogController, _ConfigController, _ContainerController, _WidgetController, _ContainerWidgetController, _ContainerItemWidgetController, _CarouselWidgetController, _EditorController, _EditorToolbarController, _WidgetListController, _ProductSelectController, _ImageSelectController, _SizeUnitController, _OpacityController, _PanelController, _PanelService, _PanelBarService, _DragDirective, _WidgetDirective, _ContainerWidgetDirective, _ContainerItemWidgetDirective, _CarouselWidgetDirective, _StrictClassDirective, _StrictSrcDirective, _EditorDirective, _WidgetListDirective, _ProductSelectDirective, _ImageSelectDirective, _SizeUnitDirective, _OpacityDirective) {
    'use strict';
