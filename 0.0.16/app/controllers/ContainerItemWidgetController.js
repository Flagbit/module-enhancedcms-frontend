define(['exports', './AbstractWidgetController.min.js', 'jquery'], function (exports, _AbstractWidgetControllerMin, _jquery) {
    ...
    var ContainerItemWidgetController = function (_AbstractWidgetContro) {
        ...
        function ContainerItemWidgetController($rootScope, $scope, $element, $attrs, $mdDialog, $compile, $q, $log, ecmsPanel, $timeout, $translate, $templateCache, $templateRequest) {
            ...
            if ($element) {
                if ($element.hasClass(ContainerItemWidgetController.getEmptyClass())) {
        ...
        _createClass(ContainerItemWidgetController, [{
            ...
            value: function click(event) {
                ...
                if (this.$scope.empty || typeof this.$scope.empty === 'undefined') {
                    this.$mdDialog.show({
                        ...
                        _this2.$scope.$element.removeClass(ContainerItemWidgetController.getEmptyClass()).attr('data-widget', widget.getName());
            ...
            value: function remove(event) {
                ...
                this.removeConfirmation().then(function () {
                    _this3.$scope.$element.addClass(ContainerItemWidgetController.getEmptyClass()).find('.ecms-widget-content').remove();
            ...
            value: function getContainerClass() {
                return 'ecms-widget-container-item';
            }
        }, {
            key: 'getContainerSelector',
            value: function getContainerSelector() {
                return '.' + ContainerItemWidgetController.getContainerClass();
            }
        }, {
            key: 'getEmptyClass',
            value: function getEmptyClass() {
                return 'ecms-widget-container-item-empty';
            }
        }, {
            key: 'getEmptySelector',
            value: function getEmptySelector() {
                return '.' + ContainerItemWidgetController.getEmptyClass();
            }
        }, {
            key: 'generate',
            value: function generate(xlCol, lgCol, mdCol, smCol) {
                if (!xlCol) {
                    xlCol = 12;
                }
                ...
                var item = (0, _jquery2.default)('<div class="ecms-col ecms-widget ' + ContainerItemWidgetController.getContainerClass() + ' ' + ContainerItemWidgetController.getEmptyClass() + ' ecms-container-item-widget-directive col-xl-' + xlCol + ' col-lg-' + lgCol + ' col-md-' + mdCol + ' col-sm-' + smCol + '" ng-click="ctrl.click($event)">' + '</div>');
                var button = (0, _jquery2.default)('<button class="md-button md-raised md-primary">Add Widget</button>');
                item.append(button);
