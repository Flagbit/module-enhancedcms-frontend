define(['exports', './AbstractWidgetController.min.js', './ContainerItemWidgetController.min.js', 'jquery'], function (exports, _AbstractWidgetControllerMin, _ContainerItemWidgetControllerMin, _jquery) {
    'use strict';
    ...
    var WidgetController = function (_AbstractWidgetContro) {
        ...
        function WidgetController($rootScope, $scope, $element, $attrs, $mdDialog, $compile, $q, $log, ecmsPanel, $timeout, $translate, $templateCache, $templateRequest) {
            ...
            _this.last = $element.find(_ContainerItemWidgetControllerMin2.default.getContainerSelector()).last();
            return _this;
        }
        ...
        _createClass(WidgetController, [{
            ...
            key: 'addWidgetContainerItem',
            value: function addWidgetContainerItem(xlCol, lgCol, mdCol, smCol) {
                var item = _ContainerItemWidgetControllerMin2.default.generate(xlCol, lgCol, mdCol, smCol);
                (0, _jquery2.default)(item).insertAfter(this.$element.find(_ContainerItemWidgetControllerMin2.default.getContainerSelector()).last());
                this.last = this.$compile(item)(this.$scope);
            }
        }]);
