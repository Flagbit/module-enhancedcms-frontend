define(['jquery', './plugins/productSelect.min.js', './plugins/imageSelect.min.js', './plugins/sideSizes.min.js', './plugins/size.min.js', './plugins/color.min.js', './plugins/opacity.min.js', './plugins/replaceQuotes.min.js', './jsonform.min.js'], function (_jquery, _productSelectMin, _imageSelectMin, _sideSizesMin, _sizeMin, _colorMin, _opacityMin, _replaceQuotesMin) {
  'use strict';
